...
type GetPropertyValuesRequest struct {
	...
	// If choosing in arc (default is out arc).
	InArc                bool     `protobuf:"varint,5,opt,name=in_arc,json=inArc,proto3" json:"in_arc,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *GetPropertyValuesRequest) GetInArc() bool {
	if m != nil {
		return m.InArc
	}
	return false
...
var fileDescriptor_b26934ec017ec8df = []byte{
	...
	,
}
