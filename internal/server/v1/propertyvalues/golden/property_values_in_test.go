	...
	testSuite := func(mixer pb.MixerClient, latencyTest bool) {
		for _, c := range []struct {
			...
			},
			{
				...
				"geoId/06",
				500,
				"",
			},
			{
				"geoOverlaps.json",
				"geoOverlaps",
