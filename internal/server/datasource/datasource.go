...
// It automatically partitions multi-node requests into chunks and executes
...
func NodeFetchAll(ctx context.Context, ds DataSource, req *pbv2.NodeRequest, pageSize int) (*pbv2.NodeResponse, error) {
	...
	return nodefetcher.NodeFetchAllChunkedFunc(ctx, func(ctx context.Context, req *pbv2.NodeRequest) (*pbv2.NodeResponse, error) {
