...
func TestPropertiesV3(t *testing.T) {
	t.Parallel()
	ctx := context.Background()

	_, filename, _, _ := runtime.Caller(0)
	goldenPath := path.Join(path.Dir(filename), "../../v2/properties/golden/properties")
	...
	if err := test.TestDriver(
		"PropertiesV3", &test.TestOption{UseSQLite: true}, testSuite); err != nil {
