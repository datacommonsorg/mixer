...
func TestParseAvailabilityRequest_Constraints(t *testing.T) {
	tests := []struct {
		...
		{
			name:        "unit",
			tail:        availabilityTail("unit"),
			originalURI: availabilityURI("unit", "c[variableMeasured]=Count_Person"),
			wantPath:    availabilityPath("unit"),
			want:        map[string][]string{"variableMeasured": {"Count_Person"}},
		},
		{
			name:        "measurement method",
			tail:        availabilityTail("measurementMethod"),
			originalURI: availabilityURI("measurementMethod", "c[variableMeasured]=Count_Person"),
			wantPath:    availabilityPath("measurementMethod"),
			want:        map[string][]string{"variableMeasured": {"Count_Person"}},
		},
		{
			name:        "observation period",
			tail:        availabilityTail("observationPeriod"),
			originalURI: availabilityURI("observationPeriod", "c[variableMeasured]=Count_Person"),
			wantPath:    availabilityPath("observationPeriod"),
			want:        map[string][]string{"variableMeasured": {"Count_Person"}},
		},
		{
			name:        "variable measured",
			tail:        availabilityTail("variableMeasured"),
			originalURI: availabilityURI("variableMeasured", "c[variableMeasured]=Count_Person"),
			wantPath:    availabilityPath("variableMeasured"),
			want:        map[string][]string{"variableMeasured": {"Count_Person"}},
		},
		{
