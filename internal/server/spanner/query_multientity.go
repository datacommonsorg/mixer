...
func (nc *multiEntityClient) CheckVariableGroupPlaceExistence(ctx context.Context, variableGroups []string, entities []string, predicate string) ([][]string, error) {
	...
	stmt := getMultiEntityGroupPlaceExistenceQuery(variableGroups, entities, predicate, nc.statements)
	return queryDynamic(ctx, nc.sc, *stmt)
}
...
func (nc *multiEntityClient) GetStatVarGroupNode(ctx context.Context, nodes []string, includeDefinitions bool) ([]*StatVarGroupNode, error) {
	...
	err := queryStructs(
		ctx,
		nc.sc,
		*getMultiEntityStatVarGroupNodeQuery(nodes, includeDefinitions, nc.statements),
		func() interface{} {
...
func (nc *multiEntityClient) getSingleFilteredStatVarGroupNode(ctx context.Context, node string, constrainedPlaces []string, constrainedImport string, numEntitiesExistence int, includeDefinitions bool) (*FilteredStatVarGroupNode, error) {
	...
	errGroup.Go(func() error {
		return queryStructs(
			errCtx,
			nc.sc,
			*getMultiEntityFilteredSVGChildrenQuery(templateSV, node, constrainedPlaces, constrainedImport, numEntitiesExistence, includeDefinitions, nc.statements),
			func() interface{} {
				return &ChildSV{}
			},
			func(rowStruct interface{}) {
	...
	errGroup.Go(func() error {
		return queryStructs(
			errCtx,
			nc.sc,
			*getMultiEntityFilteredSVGChildrenQuery(templateSVG, node, constrainedPlaces, constrainedImport, numEntitiesExistence, includeDefinitions, nc.statements),
			func() interface{} {
				return &ChildSVG{}
			},
			func(rowStruct interface{}) {
...
func (nc *multiEntityClient) GetFilteredTopic(ctx context.Context, nodes []string, constrainedPlaces []string, constrainedImport string, numEntitiesExistence int) (map[string]int, error) {
	...
	stmt := getMultiEntityFilteredTopicChildrenQuery(nodes, constrainedPlaces, constrainedImport, numEntitiesExistence, nc.statements)
