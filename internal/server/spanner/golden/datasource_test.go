...
func (m *mockSpannerClient) VectorSearchQuery(ctx context.Context, tableName string, limit int, embeddings []float64, numLeaves int, threshold float64, nodeTypeFilters []string, embeddingType string) ([]*spanner.VectorSearchResult, error) {
	return nil, nil
}
