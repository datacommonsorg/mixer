...
VALUES
  ...
  ('Count_RemoteMigration', 'Count_RemoteMigration'),
	('Count_TimeSeries', 'Count_TimeSeries'),
  ('Count_Person', 'Count_Person'),
  ('Count_Refugee', 'Count_Refugee'),
	('Country', 'Country'),
	('State', 'State'),
	('asia', 'asia'),
	('country/BLZ', 'country/BLZ'),
...
VALUES
  ...
  ('Count_Migration', 'migration-gbr-fra', 'excluded-facet', JSON '{"entity1":"country/GBR","entity2":"country/FRA"}', JSON '{"measurementMethod":"Modeled","observationPeriod":"P5Y","provenance":"dc/base/Excluded","unit":"Index"}', PENDING_COMMIT_TIMESTAMP()),
	('Count_RemoteMigration', 'remote-migration-blz-usa', 'facet', JSON '{"entity1":"country/BLZ","entity2":"country/USA"}', JSON '{"measurementMethod":"Census","observationPeriod":"P1Y","provenance":"dc/base/HumanReadableStatVars","unit":"Count"}', PENDING_COMMIT_TIMESTAMP()),
	('Count_RemoteMigration', 'remote-migration-can-usa', 'facet', JSON '{"entity1":"country/CAN","entity2":"country/USA"}', JSON '{"measurementMethod":"Census","observationPeriod":"P1Y","provenance":"dc/base/HumanReadableStatVars","unit":"Count"}', PENDING_COMMIT_TIMESTAMP()),
  ...
  ('Count_Person', 'person-usa', 'facet', JSON '{"entity1":"country/USA"}', JSON '{"measurementMethod":"Census","observationPeriod":"P1Y","provenance":"dc/base/HumanReadableStatVars","unit":"Count"}', PENDING_COMMIT_TIMESTAMP()),
	('Count_TimeSeries', 'time-series-a', 'facet-a', JSON '{"entity1":"country/USA"}', JSON '{"measurementMethod":"Census","observationPeriod":"P1Y","provenance":"dc/base/HumanReadableStatVars","unit":"Count"}', PENDING_COMMIT_TIMESTAMP()),
	('Count_TimeSeries', 'time-series-b', 'facet-b', JSON '{"entity1":"country/USA"}', JSON '{"measurementMethod":"Survey","observationPeriod":"P1Y","provenance":"dc/base/HumanReadableStatVars","unit":"Count"}', PENDING_COMMIT_TIMESTAMP()),
...
VALUES
  ...
  ('Count_Migration', 'country/GBR', 'migration-gbr-fra', 'excluded-facet', '2022', '99', PENDING_COMMIT_TIMESTAMP()),
	('Count_RemoteMigration', 'country/BLZ', 'remote-migration-blz-usa', 'facet', '2024', '40', PENDING_COMMIT_TIMESTAMP()),
	('Count_RemoteMigration', 'country/CAN', 'remote-migration-can-usa', 'facet', '2024', '30', PENDING_COMMIT_TIMESTAMP()),
  ...
  ('Count_Person', 'country/USA', 'person-usa', 'facet', '2024', '100', PENDING_COMMIT_TIMESTAMP()),
	('Count_TimeSeries', 'country/USA', 'time-series-a', 'facet-a', '2020', '10', PENDING_COMMIT_TIMESTAMP()),
	('Count_TimeSeries', 'country/USA', 'time-series-a', 'facet-a', '2022', '12', PENDING_COMMIT_TIMESTAMP()),
	('Count_TimeSeries', 'country/USA', 'time-series-b', 'facet-b', '2021', '20', PENDING_COMMIT_TIMESTAMP()),
	('Count_TimeSeries', 'country/USA', 'time-series-b', 'facet-b', '2023', '23', PENDING_COMMIT_TIMESTAMP()),
