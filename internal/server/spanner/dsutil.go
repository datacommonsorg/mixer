...
func observationsToObservationResponse(variables []string, observations []*Observation) *pbv3.ObservationResponse {
...
func observationToFacetObservation(observation *Observation) (string, *pb.Facet, *pbv2.FacetObservation) {
