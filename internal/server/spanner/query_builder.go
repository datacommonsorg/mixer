...
func VectorSearchQuery(tableName string, limit int, embeddings []float64, numLeaves int, threshold float64, nodeTypeFilters []string, embeddingType string) *spanner.Statement {
