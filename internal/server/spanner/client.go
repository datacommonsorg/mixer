...
type SpannerClient interface {
	...
	VectorSearchQuery(ctx context.Context, tableName string, limit int, embeddings []float64, numLeaves int, threshold float64, nodeFilters []string) ([]*VectorSearchResult, error)
