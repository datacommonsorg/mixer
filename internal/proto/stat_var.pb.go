...
var file_stat_var_proto_rawDesc = []byte{
	...
	0x74, 0x63, 0x68, 0x65, 0x73, 0x4a, 0x04, 0x08, 0x02, 0x10, 0x03, 0x22, 0x71, 0x0a, 0x1d, 0x46,
	0x69, 0x6c, 0x74, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x56, 0x61, 0x72, 0x73, 0x42, 0x79, 0x45,
	0x6e, 0x74, 0x69, 0x74, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x34, 0x0a, 0x09,
	...
	0x72, 0x73, 0x12, 0x1a, 0x0a, 0x08, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x69, 0x65, 0x73, 0x18, 0x02,
	0x20, 0x03, 0x28, 0x09, 0x52, 0x08, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x69, 0x65, 0x73, 0x22, 0x56,
	0x0a, 0x1e, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x56, 0x61, 0x72, 0x73,
	...
	0x61, 0x74, 0x56, 0x61, 0x72, 0x73, 0x42, 0x30, 0x5a, 0x2e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
func file_stat_var_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_stat_var_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FilterStatVarsByEntityRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_stat_var_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*FilterStatVarsByEntityResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
