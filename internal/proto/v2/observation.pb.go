...
type FacetFilter struct {
	...
	// When specified, only observations with provenance in these domain are
	// returned.
	Domains []string `protobuf:"bytes,4,rep,name=domains,proto3" json:"domains,omitempty"`
	// key is variable dcid and value is facet id to filter for. For all variables
	// with a facet id to filter for, only observations with that facet id are
	// returned.
	FacetId map[string]string `protobuf:"bytes,5,rep,name=facet_id,json=facetId,proto3" json:"facet_id,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *FacetFilter) GetFacetId() map[string]string {
	if x != nil {
		return x.FacetId
	}
	return nil
...
var file_v2_observation_proto_rawDesc = []byte{
	...
	0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x83, 0x02, 0x0a, 0x0b, 0x46, 0x61, 0x63, 0x65,
	...
	0x6f, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x73, 0x18, 0x04, 0x20,
	0x03, 0x28, 0x09, 0x52, 0x07, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x73, 0x12, 0x43, 0x0a, 0x08,
	0x66, 0x61, 0x63, 0x65, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x28,
	0x2e, 0x64, 0x61, 0x74, 0x61, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x73, 0x2e, 0x76, 0x32, 0x2e,
	0x46, 0x61, 0x63, 0x65, 0x74, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x2e, 0x46, 0x61, 0x63, 0x65,
	0x74, 0x49, 0x64, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x07, 0x66, 0x61, 0x63, 0x65, 0x74, 0x49,
	0x64, 0x1a, 0x3a, 0x0a, 0x0c, 0x46, 0x61, 0x63, 0x65, 0x74, 0x49, 0x64, 0x45, 0x6e, 0x74, 0x72,
	...
	,
	...
	,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2e, 0x42, 0x79, 0x56, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c, 0x65,
	0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x0a, 0x62, 0x79, 0x56, 0x61, 0x72, 0x69, 0x61, 0x62, 0x6c,
	0x65, 0x12, 0x47, 0x0a, 0x06, 0x66, 0x61, 0x63, 0x65, 0x74, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2e, 0x46, 0x61, 0x63, 0x65, 0x74, 0x73, 0x45, 0x6e, 0x74,
	0x72, 0x79, 0x52, 0x06, 0x66, 0x61, 0x63, 0x65, 0x74, 0x73, 0x1a, 0x62, 0x0a, 0x0f, 0x42, 0x79,
	...
	0x69, 0x6f, 0x6e, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x4d,
	...
	0x65, 0x74, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x33, 0x5a,
...
var file_v2_observation_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_v2_observation_proto_goTypes = []interface{}{
	...
	nil,                         // 8: datacommons.v2.FacetFilter.FacetIdEntry
	nil,                         // 9: datacommons.v2.ObservationResponse.ByVariableEntry
	nil,                         // 10: datacommons.v2.ObservationResponse.FacetsEntry
	(*proto.PointStat)(nil),     // 11: datacommons.PointStat
	(*proto.Facet)(nil),         // 12: datacommons.Facet
}
var file_v2_observation_proto_depIdxs = []int32{
	...
	11, // 2: datacommons.v2.FacetObservation.observations:type_name -> datacommons.PointStat
	8,  // 3: datacommons.v2.FacetFilter.facet_id:type_name -> datacommons.v2.FacetFilter.FacetIdEntry
	0,  // 4: datacommons.v2.ObservationRequest.variable:type_name -> datacommons.v2.DcidOrExpression
	0,  // 5: datacommons.v2.ObservationRequest.entity:type_name -> datacommons.v2.DcidOrExpression
	4,  // 6: datacommons.v2.ObservationRequest.filter:type_name -> datacommons.v2.FacetFilter
	9,  // 7: datacommons.v2.ObservationResponse.by_variable:type_name -> datacommons.v2.ObservationResponse.ByVariableEntry
	10, // 8: datacommons.v2.ObservationResponse.facets:type_name -> datacommons.v2.ObservationResponse.FacetsEntry
	2,  // 9: datacommons.v2.VariableObservation.ByEntityEntry.value:type_name -> datacommons.v2.EntityObservation
	1,  // 10: datacommons.v2.ObservationResponse.ByVariableEntry.value:type_name -> datacommons.v2.VariableObservation
	12, // 11: datacommons.v2.ObservationResponse.FacetsEntry.value:type_name -> datacommons.Facet
