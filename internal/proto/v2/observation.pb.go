...
type ObservationResponse struct {
	...
	// Unique ID that identifies this response. Used in usage logging in the website
	// Plural to be compatible with website logging that can have multiple IDs
	MixerResponseIds []string `protobuf:"bytes,3,rep,name=mixer_response_ids,json=mixerResponseIds,proto3" json:"mixer_response_ids,omitempty"`
}
...
func (x *ObservationResponse) GetMixerResponseIds() []string {
	if x != nil {
		return x.MixerResponseIds
	}
	return nil
}
...
var file_v2_observation_proto_rawDesc = []byte{
	...
	0x06, 0x73, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x22, 0x95, 0x03, 0x0a, 0x13, 0x4f, 0x62, 0x73, 0x65,
	...
	0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x06, 0x66, 0x61, 0x63, 0x65, 0x74, 0x73, 0x12, 0x2c,
	0x0a, 0x12, 0x6d, 0x69, 0x78, 0x65, 0x72, 0x5f, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x5f, 0x69, 0x64, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x10, 0x6d, 0x69, 0x78, 0x65,
	0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x49, 0x64, 0x73, 0x1a, 0x62, 0x0a, 0x0f,
