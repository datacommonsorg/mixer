...
// Request for the temporary SDMX query parsing probe.
// Query parameters are intentionally omitted. The probe reads the original URL
// forwarded by Envoy and parses SDMX query parameters in the Mixer handler.
type SdmxQueryProbeRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SdmxQueryProbeRequest) Reset() {
	*x = SdmxQueryProbeRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_v3_data_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *SdmxQueryProbeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SdmxQueryProbeRequest) ProtoMessage() {}

func (x *SdmxQueryProbeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_v3_data_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SdmxQueryProbeRequest.ProtoReflect.Descriptor instead.
func (*SdmxQueryProbeRequest) Descriptor() ([]byte, []int) {
	return file_v3_data_proto_rawDescGZIP(), []int{2}
}

func (x *SdmxQueryProbeRequest) GetContext() string {
	if x != nil {
		return x.Context
	}
	return ""
...
func (x *SdmxQueryProbeRequest) GetAgencyId() string {
	if x != nil {
		return x.AgencyId
	}
	return ""
...
func (x *SdmxQueryProbeRequest) GetResourceId() string {
	if x != nil {
		return x.ResourceId
	}
	return ""
...
func (x *SdmxQueryProbeRequest) GetVersion() string {
	if x != nil {
		return x.Version
	}
	return ""
...
func (x *SdmxQueryProbeRequest) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
var file_v3_data_proto_rawDesc = []byte{
	...
	0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x22, 0x9b, 0x01, 0x0a, 0x15, 0x53, 0x64, 0x6d,
	...
	0x08, 0x61, 0x67, 0x65, 0x6e, 0x63, 0x79, 0x49, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x72, 0x65, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a,
	0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x76, 0x65,
	0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x76, 0x65, 0x72,
	0x73, 0x69, 0x6f, 0x6e, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x42, 0x33, 0x5a, 0x31, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_v3_data_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_v3_data_proto_goTypes = []interface{}{
	...
	(*SdmxQueryProbeRequest)(nil), // 2: datacommons.v3.SdmxQueryProbeRequest
}
...
func file_v3_data_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_v3_data_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SdmxQueryProbeRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
