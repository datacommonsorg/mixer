...
type TriplesResponse struct {
	...
	InEntities  map[string]*EntityInfoCollection `protobuf:"bytes,1,rep,name=in_entities,json=inEntities,proto3" json:"in_entities,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`    // Key is predicate.
	OutEntities map[string]*EntityInfoCollection `protobuf:"bytes,2,rep,name=out_entities,json=outEntities,proto3" json:"out_entities,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // Key is predicate.
...
func (x *TriplesResponse) GetInEntities() map[string]*EntityInfoCollection {
	if x != nil {
		return x.InEntities
	}
	return nil
...
func (x *TriplesResponse) GetOutEntities() map[string]*EntityInfoCollection {
	if x != nil {
		return x.OutEntities
	}
	return nil
}
...
var file_v1_triples_proto_rawDesc = []byte{
	...
	0x22, 0x47, 0x0a, 0x0e, 0x54, 0x72, 0x69, 0x70, 0x6c, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x06, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x12, 0x1d, 0x0a, 0x0a, 0x6e, 0x65,
	0x78, 0x74, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09,
	0x6e, 0x65, 0x78, 0x74, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x9c, 0x03, 0x0a, 0x0f, 0x54, 0x72,
	0x69, 0x70, 0x6c, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x50, 0x0a,
	0x0b, 0x69, 0x6e, 0x5f, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x69, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03,
	...
	0x6e, 0x73, 0x65, 0x2e, 0x49, 0x6e, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x69, 0x65, 0x73, 0x45, 0x6e,
	0x74, 0x72, 0x79, 0x52, 0x0a, 0x69, 0x6e, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x69, 0x65, 0x73, 0x12,
	0x53, 0x0a, 0x0c, 0x6f, 0x75, 0x74, 0x5f, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x69, 0x65, 0x73, 0x18,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2e, 0x4f, 0x75, 0x74, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x69,
	0x65, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x0b, 0x6f, 0x75, 0x74, 0x45, 0x6e, 0x74, 0x69,
	0x74, 0x69, 0x65, 0x73, 0x12, 0x1d, 0x0a, 0x0a, 0x6e, 0x65, 0x78, 0x74, 0x5f, 0x74, 0x6f, 0x6b,
	0x65, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x6e, 0x65, 0x78, 0x74, 0x54, 0x6f,
	0x6b, 0x65, 0x6e, 0x1a, 0x60, 0x0a, 0x0f, 0x49, 0x6e, 0x45, 0x6e, 0x74, 0x69, 0x74, 0x69, 0x65,
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x61, 0x0a, 0x10, 0x4f, 0x75, 0x74, 0x45, 0x6e, 0x74, 0x69,
	...
	0x6e, 0x66, 0x6f, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x05, 0x76,
...
var file_v1_triples_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_v1_triples_proto_goTypes = []interface{}{
	...
	nil,                          // 2: datacommons.v1.TriplesResponse.InEntitiesEntry
	nil,                          // 3: datacommons.v1.TriplesResponse.OutEntitiesEntry
	(*EntityInfoCollection)(nil), // 4: datacommons.EntityInfoCollection
}
var file_v1_triples_proto_depIdxs = []int32{
	2, // 0: datacommons.v1.TriplesResponse.in_entities:type_name -> datacommons.v1.TriplesResponse.InEntitiesEntry
	3, // 1: datacommons.v1.TriplesResponse.out_entities:type_name -> datacommons.v1.TriplesResponse.OutEntitiesEntry
	4, // 2: datacommons.v1.TriplesResponse.InEntitiesEntry.value:type_name -> datacommons.EntityInfoCollection
	4, // 3: datacommons.v1.TriplesResponse.OutEntitiesEntry.value:type_name -> datacommons.EntityInfoCollection
