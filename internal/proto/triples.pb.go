...
type TriplesResponse struct {
	...
	// Key is property.
	Data map[string]*EntityInfoCollection `protobuf:"bytes,1,rep,name=data,proto3" json:"data,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (x *TriplesResponse) GetData() map[string]*EntityInfoCollection {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_v1_triples_proto_rawDesc = []byte{
	...
	0x78, 0x74, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xcb, 0x01, 0x0a, 0x0f, 0x54, 0x72, 0x69, 0x70,
	...
	0x6e, 0x65, 0x78, 0x74, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x1a, 0x5a, 0x0a, 0x09, 0x44, 0x61, 0x74,
