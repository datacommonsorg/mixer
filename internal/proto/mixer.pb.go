...
type GetStatVarGroupNodeRequest struct {
	...
	// The stat var group to query for.
...
var file_mixer_proto_rawDesc = []byte{
	...
	0x04, 0x08, 0x06, 0x10, 0x07, 0x32, 0xc6, 0x1c, 0x0a, 0x05, 0x4d, 0x69, 0x78, 0x65, 0x72, 0x12,
	...
	0x2d, 0x70, 0x6c, 0x61, 0x63, 0x65, 0x3a, 0x01, 0x2a, 0x12, 0x8d, 0x01, 0x0a, 0x0f, 0x47, 0x65,
	...
	0x2e, 0x53, 0x74, 0x61, 0x74, 0x56, 0x61, 0x72, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x22, 0x39,
	0x82, 0xd3, 0xe4, 0x93, 0x02, 0x33, 0x12, 0x15, 0x2f, 0x70, 0x6c, 0x61, 0x63, 0x65, 0x2f, 0x73,
	...
	,
...
var file_mixer_proto_msgTypes = make([]protoimpl.MessageInfo, 67)
var file_mixer_proto_goTypes = []interface{}{
	...
	nil,                                         // 56: datacommons.GetLandingPageDataResponse.StatVarSeriesEntry
	nil,                                         // 57: datacommons.GetLandingPageDataResponse.AllChildPlacesEntry
	nil,                                         // 58: datacommons.GetPlaceStatsVarResponse.PlacesEntry
	nil,                                         // 59: datacommons.GetPlaceStatVarsResponse.PlacesEntry
	nil,                                         // 60: datacommons.StatVarGroups.StatVarGroupsEntry
	(*StatVarGroupNode_ChildSVG)(nil),           // 61: datacommons.StatVarGroupNode.ChildSVG
	(*StatVarGroupNode_ChildSV)(nil),            // 62: datacommons.StatVarGroupNode.ChildSV
	(*SVOPlace_Temp)(nil),                       // 63: datacommons.SVOPlace.Temp
	(*SVOObservation_Temp)(nil),                 // 64: datacommons.SVOObservation.Temp
	(*RelatedPlacesInfo_Ranking)(nil),           // 65: datacommons.RelatedPlacesInfo.Ranking
	(*RelatedPlacesInfo_Ranking_RankInfo)(nil),  // 66: datacommons.RelatedPlacesInfo.Ranking.RankInfo
	(*StatVarSeries)(nil),                       // 67: datacommons.StatVarSeries
	(*GetStatsRequest)(nil),                     // 68: datacommons.GetStatsRequest
	(*GetStatSetSeriesRequest)(nil),             // 69: datacommons.GetStatSetSeriesRequest
	(*GetStatValueRequest)(nil),                 // 70: datacommons.GetStatValueRequest
	(*GetStatSeriesRequest)(nil),                // 71: datacommons.GetStatSeriesRequest
	(*GetStatAllRequest)(nil),                   // 72: datacommons.GetStatAllRequest
	(*GetStatSetWithinPlaceRequest)(nil),        // 73: datacommons.GetStatSetWithinPlaceRequest
	(*GetStatSetRequest)(nil),                   // 74: datacommons.GetStatSetRequest
	(*GetPlaceStatDateWithinPlaceRequest)(nil),  // 75: datacommons.GetPlaceStatDateWithinPlaceRequest
	(*GetStatsResponse)(nil),                    // 76: datacommons.GetStatsResponse
	(*GetStatSetSeriesResponse)(nil),            // 77: datacommons.GetStatSetSeriesResponse
	(*GetStatValueResponse)(nil),                // 78: datacommons.GetStatValueResponse
	(*GetStatSeriesResponse)(nil),               // 79: datacommons.GetStatSeriesResponse
	(*GetStatAllResponse)(nil),                  // 80: datacommons.GetStatAllResponse
	(*GetStatSetResponse)(nil),                  // 81: datacommons.GetStatSetResponse
...
var file_mixer_proto_depIdxs = []int32{
	...
	55, // 2: datacommons.GetLocationsRankingsResponse.payload:type_name -> datacommons.GetLocationsRankingsResponse.PayloadEntry
	20, // 3: datacommons.Places.places:type_name -> datacommons.Place
	56, // 4: datacommons.GetLandingPageDataResponse.stat_var_series:type_name -> datacommons.GetLandingPageDataResponse.StatVarSeriesEntry
	57, // 5: datacommons.GetLandingPageDataResponse.all_child_places:type_name -> datacommons.GetLandingPageDataResponse.AllChildPlacesEntry
	...
	58, // 8: datacommons.GetPlaceStatsVarResponse.places:type_name -> datacommons.GetPlaceStatsVarResponse.PlacesEntry
	59, // 9: datacommons.GetPlaceStatVarsResponse.places:type_name -> datacommons.GetPlaceStatVarsResponse.PlacesEntry
	33, // 10: datacommons.GetPlaceStatVarsUnionResponse.stat_vars:type_name -> datacommons.StatVars
	60, // 11: datacommons.StatVarGroups.stat_var_groups:type_name -> datacommons.StatVarGroups.StatVarGroupsEntry
	62, // 12: datacommons.StatVarGroupNode.child_stat_vars:type_name -> datacommons.StatVarGroupNode.ChildSV
	61, // 13: datacommons.StatVarGroupNode.child_stat_var_groups:type_name -> datacommons.StatVarGroupNode.ChildSVG
	44, // 14: datacommons.SVOPlace.observations:type_name -> datacommons.SVOObservation
	63, // 15: datacommons.SVOPlace.temp:type_name -> datacommons.SVOPlace.Temp
	64, // 16: datacommons.SVOObservation.temp:type_name -> datacommons.SVOObservation.Temp
	...
	65, // 21: datacommons.RelatedPlacesInfo.rank_all:type_name -> datacommons.RelatedPlacesInfo.Ranking
	65, // 22: datacommons.RelatedPlacesInfo.rank_top_1000:type_name -> datacommons.RelatedPlacesInfo.Ranking
	65, // 23: datacommons.RelatedPlacesInfo.rank_bottom_1000:type_name -> datacommons.RelatedPlacesInfo.Ranking
	54, // 24: datacommons.GetLocationsRankingsResponse.PayloadEntry.value:type_name -> datacommons.RelatedPlacesInfo
	67, // 25: datacommons.GetLandingPageDataResponse.StatVarSeriesEntry.value:type_name -> datacommons.StatVarSeries
	...
	66, // 30: datacommons.RelatedPlacesInfo.Ranking.info:type_name -> datacommons.RelatedPlacesInfo.Ranking.RankInfo
	...
	68, // 37: datacommons.Mixer.GetStats:input_type -> datacommons.GetStatsRequest
	69, // 38: datacommons.Mixer.GetStatSetSeries:input_type -> datacommons.GetStatSetSeriesRequest
	70, // 39: datacommons.Mixer.GetStatValue:input_type -> datacommons.GetStatValueRequest
	71, // 40: datacommons.Mixer.GetStatSeries:input_type -> datacommons.GetStatSeriesRequest
	72, // 41: datacommons.Mixer.GetStatAll:input_type -> datacommons.GetStatAllRequest
	73, // 42: datacommons.Mixer.GetStatSetWithinPlace:input_type -> datacommons.GetStatSetWithinPlaceRequest
	74, // 43: datacommons.Mixer.GetStatSet:input_type -> datacommons.GetStatSetRequest
	...
	75, // 54: datacommons.Mixer.GetPlaceStatDateWithinPlace:input_type -> datacommons.GetPlaceStatDateWithinPlaceRequest
	...
	3,  // 57: datacommons.Mixer.Query:output_type -> datacommons.QueryResponse
	7,  // 58: datacommons.Mixer.GetPropertyLabels:output_type -> datacommons.GetPropertyLabelsResponse
	9,  // 59: datacommons.Mixer.GetPropertyValues:output_type -> datacommons.GetPropertyValuesResponse
	11, // 60: datacommons.Mixer.GetTriples:output_type -> datacommons.GetTriplesResponse
	15, // 61: datacommons.Mixer.GetPlacesIn:output_type -> datacommons.GetPlacesInResponse
	45, // 62: datacommons.Mixer.GetPlaceObs:output_type -> datacommons.SVOCollection
	76, // 63: datacommons.Mixer.GetStats:output_type -> datacommons.GetStatsResponse
	77, // 64: datacommons.Mixer.GetStatSetSeries:output_type -> datacommons.GetStatSetSeriesResponse
	78, // 65: datacommons.Mixer.GetStatValue:output_type -> datacommons.GetStatValueResponse
	79, // 66: datacommons.Mixer.GetStatSeries:output_type -> datacommons.GetStatSeriesResponse
	80, // 67: datacommons.Mixer.GetStatAll:output_type -> datacommons.GetStatAllResponse
	81, // 68: datacommons.Mixer.GetStatSetWithinPlace:output_type -> datacommons.GetStatSetResponse
	81, // 69: datacommons.Mixer.GetStatSet:output_type -> datacommons.GetStatSetResponse
	18, // 70: datacommons.Mixer.GetLocationsRankings:output_type -> datacommons.GetLocationsRankingsResponse
	19, // 71: datacommons.Mixer.GetRelatedLocations:output_type -> datacommons.GetRelatedLocationsResponse
	23, // 72: datacommons.Mixer.GetLandingPageData:output_type -> datacommons.GetLandingPageDataResponse
	5,  // 73: datacommons.Mixer.Translate:output_type -> datacommons.TranslateResponse
	25, // 74: datacommons.Mixer.Search:output_type -> datacommons.SearchResponse
	27, // 75: datacommons.Mixer.GetVersion:output_type -> datacommons.GetVersionResponse
	32, // 76: datacommons.Mixer.GetPlaceStatsVar:output_type -> datacommons.GetPlaceStatsVarResponse
	35, // 77: datacommons.Mixer.GetPlaceStatVars:output_type -> datacommons.GetPlaceStatVarsResponse
	38, // 78: datacommons.Mixer.GetPlaceStatVarsUnionV1:output_type -> datacommons.GetPlaceStatVarsUnionResponseV1
	37, // 79: datacommons.Mixer.GetPlaceStatVarsUnion:output_type -> datacommons.GetPlaceStatVarsUnionResponse
	82, // 80: datacommons.Mixer.GetPlaceStatDateWithinPlace:output_type -> datacommons.GetPlaceStatDateWithinPlaceResponse
	39, // 81: datacommons.Mixer.GetStatVarGroup:output_type -> datacommons.StatVarGroups
	40, // 82: datacommons.Mixer.GetStatVarGroupNode:output_type -> datacommons.StatVarGroupNode
