...
type ProteinPageRequest struct {
...
type ProteinPageResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Entity string      `protobuf:"bytes,1,opt,name=entity,proto3" json:"entity,omitempty"`
	Data   *GraphNodes `protobuf:"bytes,2,opt,name=data,proto3" json:"data,omitempty"`
}

func (x *ProteinPageResponse) Reset() {
	*x = ProteinPageResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ProteinPageResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProteinPageResponse) ProtoMessage() {}

func (x *ProteinPageResponse) ProtoReflect() protoreflect.Message {
	mi := &file_v1_page_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProteinPageResponse.ProtoReflect.Descriptor instead.
func (*ProteinPageResponse) Descriptor() ([]byte, []int) {
	return file_v1_page_proto_rawDescGZIP(), []int{1}
}

func (x *ProteinPageResponse) GetEntity() string {
	if x != nil {
		return x.Entity
	}
	return ""
...
func (x *ProteinPageResponse) GetData() *GraphNodes {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_v1_page_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x65, 0x69, 0x6e, 0x50, 0x61, 0x67, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
...
func file_v1_page_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_v1_page_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProteinPageResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
