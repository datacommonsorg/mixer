...
type GetVersionResponse struct {
	...
	// Base Bigtable instance
	BaseTables []string `protobuf:"bytes,5,rep,name=base_tables,json=baseTables,proto3" json:"base_tables,omitempty"`
	// Branch Bigtable instance
	BranchTable string `protobuf:"bytes,6,opt,name=branch_table,json=branchTable,proto3" json:"branch_table,omitempty"`
	// Github commit hash
...
func (x *GetVersionResponse) GetBaseTables() []string {
	if x != nil {
		return x.BaseTables
	}
	return nil
...
func (x *GetVersionResponse) GetBranchTable() string {
	if x != nil {
		return x.BranchTable
	}
	return ""
}
...
var file_misc_proto_rawDesc = []byte{
	...
	0xac, 0x01, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x65,
	...
	0x08, 0x62, 0x69, 0x67, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12, 0x1f, 0x0a, 0x0b, 0x62, 0x61, 0x73,
	0x65, 0x5f, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x09, 0x52, 0x0a,
	0x62, 0x61, 0x73, 0x65, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x12, 0x21, 0x0a, 0x0c, 0x62, 0x72,
	0x61, 0x6e, 0x63, 0x68, 0x5f, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0b, 0x62, 0x72, 0x61, 0x6e, 0x63, 0x68, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x19, 0x0a,
	0x08, 0x67, 0x69, 0x74, 0x5f, 0x68, 0x61, 0x73, 0x68, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x07, 0x67, 0x69, 0x74, 0x48, 0x61, 0x73, 0x68, 0x4a, 0x04, 0x08, 0x03, 0x10, 0x04, 0x42, 0x09,
