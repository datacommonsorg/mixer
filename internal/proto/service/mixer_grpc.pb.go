...
const (
	...
	Mixer_V3FilterStatVarsByEntity_FullMethodName     = "/datacommons.Mixer/V3FilterStatVarsByEntity"
...
type MixerClient interface {
	...
	V3FilterStatVarsByEntity(ctx context.Context, in *proto.FilterStatVarsByEntityRequest, opts ...grpc.CallOption) (*proto.FilterStatVarsByEntityResponse, error)
...
func (c *mixerClient) V3FilterStatVarsByEntity(ctx context.Context, in *proto.FilterStatVarsByEntityRequest, opts ...grpc.CallOption) (*proto.FilterStatVarsByEntityResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(proto.FilterStatVarsByEntityResponse)
	err := c.cc.Invoke(ctx, Mixer_V3FilterStatVarsByEntity_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MixerServer interface {
	...
	V3FilterStatVarsByEntity(context.Context, *proto.FilterStatVarsByEntityRequest) (*proto.FilterStatVarsByEntityResponse, error)
...
func (UnimplementedMixerServer) V3FilterStatVarsByEntity(context.Context, *proto.FilterStatVarsByEntityRequest) (*proto.FilterStatVarsByEntityResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method V3FilterStatVarsByEntity not implemented")
}
...
func _Mixer_V3FilterStatVarsByEntity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(proto.FilterStatVarsByEntityRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MixerServer).V3FilterStatVarsByEntity(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Mixer_V3FilterStatVarsByEntity_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MixerServer).V3FilterStatVarsByEntity(ctx, req.(*proto.FilterStatVarsByEntityRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Mixer_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "V3FilterStatVarsByEntity",
			Handler:    _Mixer_V3FilterStatVarsByEntity_Handler,
		},
		{
			MethodName: "V2Sparql",
